    ...
    >
      <div className="hidden flex-row items-center justify-center gap-2 lg:flex">
        ...
        <button className="z-50">
          <a href="#" className="text-[#3b82f6] font-bold cursor-pointer z-50">
            SaasMaster
          </a>
        </button>
      </div>
      ...
      <button className="z-50">
        <a className="relative hidden w-fit bg-[#3b82f6] text-white hover:bg-[#3b82f6]/80  items-center justify-center gap-x-1.5 overflow-hidden rounded-full  px-3 py-1.5 dark:bg-white dark:text-black lg:inline-flex">
          Get Started
        </a>
      </button>
    </header>
